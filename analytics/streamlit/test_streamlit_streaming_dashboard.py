...
st.title("🚕 ZenClarity UrbanFlow Live Streaming Dashboard")
...
st.markdown("This chart provides a direct comparison of trips and total fare per hour between the streaming data and the historical baseline. This visualization helps us identify trends and performance anomalies over time.")
...
st.bar_chart(df_pivoted[['difference']], use_container_width=True)
st.markdown("This bar chart visualizes the performance delta. A positive bar indicates the stream is outperforming the baseline, while a negative bar would show underperformance. This is a very clear and intuitive way to present performance.")
